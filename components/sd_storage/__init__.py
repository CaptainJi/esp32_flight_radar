...
# (branch `storage-testing`, 2026-08-02) -- esphome/components/sd_storage/.
#
# Local change, in sd_storage.cpp only: upstream never sets host.pwr_ctrl_handle, so on
# ESP32-P4 the SD card's IO rail is left unpowered and the card never enumerates. See the
# comment at the top of that file. Everything else is byte-for-byte upstream.
